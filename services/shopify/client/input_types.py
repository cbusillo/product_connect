...
# Source: /opt/project/addons/product_connect/graphql/schema/shopify_schema_2025-04.sdl
...
MarketingActivityCreateInput.model_rebuild()
MarketingActivityUpdateExternalInput.model_rebuild()
MarketingActivityUpdateInput.model_rebuild()
